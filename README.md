# 🩺 YOLOv12 Polyp Detection (Polyp-11K)
...
Automatic **polyp detection from endoscopic images** using **YOLOv12**, trained on the **Roboflow Polyp Detection (Polyp-11K) dataset**.
...
Early detection of colorectal polyps is essential for preventing colorectal cancer.
This project leverages **YOLOv12**, a next-generation real-time object detection model from **Ultralytics**, to accurately detect and localize polyps in medical images.
...
```
.
├── yolov12polyp11kipynb.ipynb   # Main YOLOv12 notebook
...
1. Open the notebook:
   ...
   ```bash
   jupyter notebook yolov12polyp11kipynb.ipynb
   ```
...
* Benchmarking against YOLOv8, YOLOv10, YOLOv11, and Faster R-CNN
